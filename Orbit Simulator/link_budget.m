...
function [CNtot, link_margin, CNtot_rain, link_margin_rain]= link_budget(r,t,lambda,lambda_us, best_sat, R, best_elevation)
    ...
    Gvsat = 10*log10(efficiency*((pi*Diameter_sat*frequency_uplink)/c)^2);
    T_LNB = 290*((10^(LNB_noise_figure/10))-1);
    satellite_G_T = Gvsat - 10*log10(Tvsat + T_LNB); %G/T satellite
    ...
    T_LNB = 290*((10^(LNB_noise_figure/10)) - 1);
    GT_user = G_user - 10*log10(T_user + T_LNB); %G/T user station
